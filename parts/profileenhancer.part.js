msuParts["profileEnhancer"] = function(ScratchUserscript){
	...
	ScratchUserscript.registerPart("Profile Enhancer", "Adds extra features and enchancements to profile pages.", settingsDlg);

	var isEnabled = ScratchUserscript.isPartEnabled("profileEnhancer");
	
	var settings = {liveProject: false, sectionShared: true, sectionFavorite: true, sectionStudioFollow: true, sectionStudioCurate: true, sectionFollowing: true, sectionFollowers: true, sectionComments: true};
