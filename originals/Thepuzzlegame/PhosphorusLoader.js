...
$( ".active" ).append( '<div id="load-with-pho" class="action tooltip bottom" style="" onclick="loadWithPho()";><span class="hovertext"><span class="arrow"></span>Load this project with Phosphorus</span><span>Phosphorus</span></div>' );
